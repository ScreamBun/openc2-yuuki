...
cmdhandler = OpenC2Dispatch(rate_limit=60, versions=['1.0'])


@cmdhandler.openc2_pair('deny', 'ipv4_connection', 'slpf')
...
@cmdhandler.openc2_pair('deny', 'ipv4_net', 'slpf')
...
@cmdhandler.openc2_pair('detonate', 'x-acme:roadrunner', 'x-acme')
