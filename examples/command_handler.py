...
from yuuki import (OpenC2CmdDispatchBase, OC2CmdFields, OC2RspFields, StatusCode, oc2_query_features, oc2_pair,
...
class CommandHandler(OpenC2CmdDispatchBase):
    ...
    * x-acme: Stub implementation of Roadrunner hunting
    ...
    @oc2_query_features
    def func1(self, oc2_cmd: OC2CmdFields) -> OC2RspFields:
        """
    ...
    def func2(self, oc2_cmd: OC2CmdFields) -> OC2RspFields:
        """
        ...
        return OC2RspFields(status=StatusCode.OK, status_text=status_text)

    @oc2_pair('slpf', 'deny', 'ipv4_net')
    def func3(self, oc2_cmd: OC2CmdFields) -> OC2RspFields:
    ...
    def func4(self, oc2_cmd: OC2CmdFields) -> OC2RspFields:
        """
        ...
        if coyote_success:
            ...
            return OC2RspFields(status=StatusCode.INTERNAL_ERROR, status_text='Coyote can never win')

    @oc2_no_matching_pair
    def func5(self, oc2_cmd: OC2CmdFields) -> OC2RspFields:
        """
        We've searched all our action-target pairs from all our
        actuators, and that pair doesn't exist.
        """
        return OC2RspFields(status=StatusCode.NOT_FOUND,
                            status_text=f'No action-target pair for {oc2_cmd.action} {oc2_cmd.target_name}')

    @oc2_no_matching_actuator
    def func6(self, oc2_cmd: OC2CmdFields) -> OC2RspFields:
        """
        ...
        return OC2RspFields(status=StatusCode.NOT_FOUND, status_text=f'No actuator {actuator_name}')
